...
export const promptStarters = pgTable(
  'prompt_starters',
  {
    ...
    quickFeedbackUp: integer('quick_feedback_up').notNull().default(0),
    quickFeedbackDown: integer('quick_feedback_down').notNull().default(0),
    quickFeedbackBroken: integer('quick_feedback_broken').notNull().default(0),
